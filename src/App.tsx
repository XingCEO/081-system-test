  ...
  useEffect(() => {
    ...
    async function bootstrap() {
      try {
        ...
        // Load settings with timeout to prevent infinite hang
        await Promise.race([
        ...
        // Start syncing from server regardless of init result
        startSync(5000);
        if (!cancelled) {
          setReady(true);
        }
      ...
      <Suspense fallback={<PageLoader />}>
        <Routes>
          ...
          <Route element={<AppShell />}>
            ...
            <Route path="/tables" element={<ErrorBoundary><TableMapPage /></ErrorBoundary>} />
            ...
            <Route path="/menu-management" element={<ErrorBoundary><MenuManagementPage /></ErrorBoundary>} />
            <Route path="/inventory" element={<ErrorBoundary><InventoryPage /></ErrorBoundary>} />
            <Route path="/employees" element={<ErrorBoundary><EmployeePage /></ErrorBoundary>} />
