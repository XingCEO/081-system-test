  ...
  if (!hydrated) {
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-gray-500 dark:text-gray-400">讀取設定中...</div>
      </div>
    );
  }
    ...
    <div className="h-full overflow-auto">
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-bold text-gray-800 dark:text-white">系統設定</h1>
        </div>

        <div className="card p-6 space-y-4">
          <h2 className="text-lg font-semibold text-gray-700 dark:text-white">外觀模式</h2>
            ...
            {(['light', 'dark', 'system'] as const).map((mode) => (
              <button
                ...
                className={`py-3 rounded-xl text-sm font-medium border-2 transition-all ${
                  theme === mode
                    ? 'border-gray-800 bg-gray-100 text-gray-800 dark:border-gray-200 dark:bg-gray-800 dark:text-white'
        ...
        <div className="card p-6 space-y-4">
          <h2 className="text-lg font-semibold text-gray-700 dark:text-white flex items-center gap-2">
            <IconStorefront className="w-5 h-5" />
            店家資訊
          </h2>
          <div className="grid gap-4 md:grid-cols-2">
            <div className="md:col-span-2">
              <label className="text-sm font-medium text-gray-600 dark:text-gray-300 block mb-1">店家名稱</label>
              <input
            ...
            <div className="md:col-span-2">
              <label className="text-sm font-medium text-gray-600 dark:text-gray-300 block mb-1">店家地址</label>
              <input
            ...
            <div>
              <label className="text-sm font-medium text-gray-600 dark:text-gray-300 block mb-1">店家電話</label>
              <input
        ...
        <div className="card p-6 space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="md:col-span-2">
              <label className="text-sm font-medium text-gray-600 dark:text-gray-300 block mb-1">收據標頭</label>
              <input
            ...
            <div className="md:col-span-2">
              <label className="text-sm font-medium text-gray-600 dark:text-gray-300 block mb-1">收據頁尾</label>
              <input
            ...
            <div>
              <label className="text-sm font-medium text-gray-600 dark:text-gray-300 block mb-1">貨幣符號</label>
              <input
            ...
            <div>
              <label className="text-sm font-medium text-gray-600 dark:text-gray-300 block mb-1">訂單編號前綴</label>
              <input
                ...
                placeholder="例如：POS"
              />
              <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">預覽：{orderPreview}</p>
            </div>
          </div>
        </div>
        ...
        <div className="card p-6 space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <label className="text-sm font-medium text-gray-600 dark:text-gray-300 block mb-1">自動登出分鐘</label>
              <input
                type="number"
                min={5}
                max={240}
            ...
            <div>
              <label className="text-sm font-medium text-gray-600 dark:text-gray-300 block mb-1">低庫存預設門檻</label>
              <input
                type="number"
                min={1}
            ...
            <div className="md:col-span-2">
              <label className="text-sm font-medium text-gray-600 dark:text-gray-300 block mb-2">主題色</label>
              ...
              <div className="flex gap-3">
                <input
                  ...
                  className="h-11 w-16 rounded-lg cursor-pointer border border-gray-200 dark:border-gray-600"
                />
                <input
                  value={formValues.themeColor}
                  onChange={(event) => updateField('themeColor', event.target.value)}
              ...
              <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">儲存後會立即套用到主要按鈕、導覽與登入畫面。</p>
            </div>
            <label className="md:col-span-2 flex items-center gap-3 rounded-xl border border-gray-200 dark:border-gray-700 px-4 py-3">
              <input
                type="checkbox"
              ...
              />
              <span className="text-sm font-medium text-gray-600 dark:text-gray-300">啟用提示音</span>
            </label>
          </div>
        </div>
