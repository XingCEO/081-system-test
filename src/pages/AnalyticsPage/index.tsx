...
export default function AnalyticsPage() {
  ...
  const timeSlotBreakdown = data?.timeSlotBreakdown ?? [];
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-auto p-6">
        {loading ? (
          ...
          <div className="text-center py-16 text-red-500 dark:text-red-400 animate-fade-in">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between flex-wrap gap-2">
              ...
              {peakTimeSlot && (
                <p className="text-sm text-amber-600 dark:text-amber-400 font-medium">
                  尖峰時段：{peakTimeSlot.label} ({peakTimeSlot.hoursLabel})
                </p>
              )}
            </div>
            ...
            <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
              ...
              <div className="card p-5 animate-slide-up stagger-2">
                <p className="text-sm text-gray-500 dark:text-slate-400">食材成本</p>
                <p className="text-2xl lg:text-3xl font-bold text-red-600 dark:text-red-400 mt-1">
                  {formatPrice(data?.totalCost ?? 0)}
                </p>
                {(data?.totalCost ?? 0) === 0 && (data?.totalOrders ?? 0) > 0 && (
                  <p className="mt-1 text-xs text-gray-400 dark:text-slate-500">尚未設定 BOM 配方</p>
                )}
              </div>
              <div className="card p-5 animate-slide-up stagger-3">
                <p className="text-sm text-gray-500 dark:text-slate-400">毛利</p>
              ...
              <div className="card p-5 animate-slide-up stagger-4">
                <p className="text-sm text-gray-500 dark:text-slate-400">毛利率</p>
                <p className="text-2xl lg:text-3xl font-bold text-emerald-600 dark:text-emerald-400 mt-1">
            ...
            <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
              ...
              <div className="card p-5 animate-slide-up stagger-5">
                ...
                <p className="text-2xl lg:text-3xl font-bold text-gray-800 dark:text-slate-50 mt-1">
                  {formatPrice(data?.averageOrderValue ?? 0)}
                </p>
              </div>
              ...
              <div className="card p-5 animate-slide-up stagger-6">
                ...
                <p className="mt-1 text-xs text-gray-500 dark:text-slate-400">
                  {peakTimeSlot ? formatPrice(peakTimeSlot.revenue) : '尚無資料'}
                </p>
              </div>
            </div>
